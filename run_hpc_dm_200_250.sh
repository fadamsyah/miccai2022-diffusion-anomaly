...
export CLASSIFIER_FLAGS="--image_size 256 --classifier_attention_resolutions 32,16,8 --classifier_depth 4 --classifier_width 32 --classifier_pool attention --classifier_resblock_updown True --classifier_use_s>export SAMPLE_FLAGS="--batch_size 1 --timestep_respacing ddim1000 --use_ddim True"
...
python adam/generate_brats_healthy_volume.py \
    ...
    --sample_start_id=200 --sample_end_id=250 \
