...
# sys.path.append("..")
sys.path.append(".")
from guided_diffusion.bratsloader import BRATSDataset, BRATSDatasetVolume
...
def main():
    ...
    if args.dataset=='brats':
      ds = BRATSDatasetVolume(args.data_dir, start_idx=args.start_idx, end_idx=args.end_idx)
...
# python adam/generate_brats_healthy.py --dataset brats --data_dir=/share/sda/adam/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData/BraTS-GLI-00680-001 --start_idx=80 --end_idx=81  $MODEL_FLAGS $DIFFUSION_FLAGS $CLASSIFIER_FLAGS  $SAMPLE_FLAGS 
...
# SAMPLE_FLAGS="--batch_size 1 --timestep_respacing ddim1000 --use_ddim True"

# CUDA_VISIBLE_DEVICES=2 python adam/generate_brats_healthy.py --dataset brats --data_dir=/share/sda/adam/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData/BraTS-GLI-00680-001 --start_idx=80 --end_idx=81  $MODEL_FLAGS $DIFFUSION_FLAGS $CLASSIFIER_FLAGS  $SAMPLE_FLAGS 
